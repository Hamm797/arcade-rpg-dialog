...
namespace rpgDialog {
    ...
    */
    ...
    /**
    * Clears scrolling text log
    */
    //% blockId=clear_text_log
    //% block="clear text log"
    //% help=github:docs/clear_text_log
    export function clearTextLog() {
        state().appendImageToLog(img`
    ................................................................................................................................................................
    ................................................................................................................................................................
    ................................................................................................................................................................
    ................................................................................................................................................................
    ...
    */
    ...
    export function changeLogColors(c1: number, c2: number) {
        rpgDialog.activeColor = c1;
        rpgDialog.readColor = c2;
    }
    ...
    */
    ...
    export function setScoreOverride(thisKind: rpgDialog.Currency, thisScore: number) {
        info.setScore(thisScore)
        rpgDialog.scoreText.setText("x" + convertToText(info.score()))
        if (thisKind == rpgDialog.Currency.Coins) {
            scoreText.setIcon(img`
                ...
                . . . f f . . .
                `)
        } else if (thisKind == rpgDialog.Currency.Tickets) {
            scoreText.setIcon(img`
            . . . . . . . .
            . . . . . . . .
            4 4 4 4 4 4 4 4
            ...
            . . . . . . . .
            `)
        } else if (thisKind == rpgDialog.Currency.Candy) {
            scoreText.setIcon(img`
            . . . . . . . .
            . . . . . . . .
            2 . 2 2 2 2 . 2
    ...
    */
    ...
    export function changeScoreOverride(thisKind: rpgDialog.Currency, thisScore: number) {
        info.changeScoreBy(thisScore)
        rpgDialog.setScoreOverride(thisKind, info.score())
    }
